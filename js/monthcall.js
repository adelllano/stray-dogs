...
d3.tsv("data.tsv", function(error, data) {
  ...
  svg.selectAll(".bar")
    ...
    .enter().append("rect")
      ...
      .attr("height", function(d) { return height - y(d.calls); });
  ...
  function change() {
    ...
    var x0 = x.domain(data.sort(
      this.checked
        ? function(a, b) { return b.calls - a.calls;}
        :
        // function(d) { return x(d.month); })
    ...
    // svg.selectAll(".bar")
    //     .sort(function(a, b) { return x(a.month) - x0(b.month); });
